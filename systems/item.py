...
class ItemUI:
    def __init__(self, status, screen):
        ...
        self.font = config.skill_font

        # 仮画像（あとで差し替え可能）
        self.images = {
            "グローブ": pygame.transform.scale(pygame.image.load("assets/images/Break.bmp"), (56, 56)),
            "巻物": pygame.transform.scale(pygame.image.load("assets/images/Teleport.bmp"), (56, 56)),
            "精霊の瓶": pygame.transform.scale(pygame.image.load("assets/images/Wisp.bmp"), (56, 56)),
        }
